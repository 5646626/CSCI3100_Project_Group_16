...
class UserRepository:
    ...
    def create(self, user: Members) -> ObjectId:
        return self.create_new_user(user)
    ...
    def find_by_username(self, username: str) -> Members:
    ...
    def find_by_id(self, user_id: ObjectId) -> Members:
    ...
    def find_by_role(self, role: str) -> list:
        return self.find_user_by_role(role)
